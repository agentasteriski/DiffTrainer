...
set "CONFIG=DiffSinger\configs\acoustic.yaml"
set "NEW_VALUE="
...
if /i "%~2"=="variance" set "CONFIG=DiffSinger\configs\variance.yaml"
if /i "%~2"=="acoustic" set "CONFIG=DiffSinger\configs\acoustic.yaml"
if not defined NEW_VALUE set "NEW_VALUE=%~1"
