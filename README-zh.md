...
> [!WARNING]
> 中文版本的自述檔案內容並不一定是最新的並且可能存在有翻譯的錯誤，如果中文版本與英文原版有什麼出入的話以英文原版為準
...
## 安裝選項
### 如果你從未用過Python：
- 執行 python_installer.bat ，完成安裝程式
- 執行 setup.bat
- 之後使用 run_gui.bat 啟動
...
- 一旦安裝了Python 3.10，就可以執行 setup.bat 來下載需求元件，或執行通常的 `pip install -r requirements.txt`
